...
class videotextaudioform extends StatefulWidget {
  const videotextaudioform({Key? key}) : super(key: key);

  @override
  State<videotextaudioform> createState() => _videotextaudioformState();
}

class _videotextaudioformState extends State<videotextaudioform> {
    ...
    return SafeArea(
      child: Scaffold(  backgroundColor: Colors.grey.shade200,
        appBar: AppBar(
          ...
          title: Text('Video Text Audio Form',style: TextStyle(color: Colors.white
          ),),
        ),
        body: Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 12,),
                  Text('Reminder Text ',style: TextStyle(color: Colors.black,fontSize: 23,fontWeight: FontWeight.bold
                  ),
                  ), SizedBox(height: 16,),
                  Container(
                  ...
                  SizedBox(height: 12,),
                  Text('Reminder Video ',style: TextStyle(color: Colors.black,fontSize: 23,fontWeight: FontWeight.bold
                  ),
                  ),
                  SizedBox(height: 12,),
...
*/
                  ...
                  SizedBox(height: 12,),
                  Text('Reminder Alarm ',style: TextStyle(color: Colors.black,fontSize: 23,fontWeight: FontWeight.bold
                  ),
                  ),
                  SizedBox(height: 12,),
